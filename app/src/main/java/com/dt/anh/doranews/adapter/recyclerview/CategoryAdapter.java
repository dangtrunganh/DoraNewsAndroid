...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    ...
    private TextView textQuantityChoosen;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bindData(Category category) {
            ...
            mTextTitleCategory.setText(category.getNameCategory());
...
//            mContext.startActivity(new Intent(mContext, DetailEventActivity.class));
            ...
            if (!category.isSelected()) {
                ...
                textQuantityChoosen.setText("(Đã chọn " + mListCategoryChosen.size() + "/" + mListCategories.size() + ")");
