//package com.dt.anh.doranews.notification.audio;
//
...
//                .setLargeIcon(ArticleLibrary.getAlbumBitmap(mService, description.getMediaId()))
...
//        //Mở DetailNewsActivity
//        Intent openUI = new Intent(mService, DetailNewsActivity.class);
