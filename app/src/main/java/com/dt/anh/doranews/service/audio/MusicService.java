...
import com.dt.anh.doranews.notification.audio.MediaNotificationManager;
...
//    public void setUpdateListArticles(List<Article> mArticles) {
...
//        return new BrowserRoot(MusicLibrary.getRoot(), null);
    ...
    public void onLoadChildren(
        ...
        result.sendResult(ArticleLibrary.getMediaItems());
    }
    ...
    public class MediaSessionCallback extends MediaSessionCompat.Callback {
        ...
        public void onPrepare() {
            ...
            mPreparedMedia = ArticleLibrary.getMetadata(MusicService.this, mediaId);
